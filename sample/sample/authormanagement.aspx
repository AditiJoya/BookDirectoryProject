<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="authormanagement.aspx.cs" Inherits="sample.authormanagement" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <asp:Button ID="Button3" class="btn btn-lg btn btn-secondary" runat="server" Text="Update" OnClick="Button3_Click" />
                            </div>
                            <div class="col-4">
                                <asp:Button ID="Button4" class="btn btn-lg btn btn-secondary" runat="server" Text="Delete" OnClick="Button4_Click" />
                            </div>
                        </div>
