<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookissuing.aspx.cs" Inherits="sample.adminbookissuing" %>
         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:Button class="btn btn-secondary" ID="Button1" runat="server" Text="Search" OnClick="Button1_Click" />
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-6">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn btn-warning" runat="server" Text="Issue" OnClick="Button2_Click" />
                     </div>
                     <div class="col-6">
