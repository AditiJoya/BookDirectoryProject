<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="bookinventory.aspx.cs" Inherits="sample.bookinventory" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" Height="150px" Width="100px" src="book_inventory/b3.jpg" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Member ID"></asp:TextBox>
                               <asp:Button class="form-control btn btn-primary" ID="Button4" runat="server" Text="Search" OnClick="Button4_Click" />
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                     <div class="col-12">
                        <label>Book Buy Link</label>
                        <div class="form-group">
                            <asp:TextBox CssClass="form-control" ID="TextBox12" runat="server" placeholder="Add link" TextMode="Url" Rows="2"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    Book Buy Link-
                                                    <asp:Label ID="Label13" runat="server" Font-Bold="True" Text='<%# Eval("book_buy_link") %>'></asp:Label>
